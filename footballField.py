    ...
    while exitRoom == False:
        ...
        if userAction == 'yes' or 'Yes':
                    ...
                    if userAction == 'bullet' or 'Throw a bullet' or 'throw a bullet':
                        ...
                        if userAction == 'pass':
                            ...
                            if userAction == 'tuck and run':
                                ...
                                if userAction == 'juke right' or 'Juke right':
                                    ...
                                    defense = True
                                if userAction == 'juke left' or 'Juke left':
                                    ...
                                    if userAction == 'stiff arm' or 'Stiff arm':
                                        ...
                                        if userAction == 'go back to the playground' or 'Go back to the playground':
                                            print ('You are a pathetic loser. Restart the game')
                                            restart()
                                        if userAction == 'fight the children' or 'Fight the children':
                        ...
                        if userAction == 'run' or 'Run':
                            ...
                            if userAction == 'dive on the ball' or 'Dive on the ball':
                                print('You dive on the ball but all the dhildren fall on top of you and crush you.')
                                print ('You died.')
                                restart()
                            if userAction == 'let the defense take it' or 'Let the defense take it':
                                print('What a weakling. You watch the other team take the football.')
                                defense = True
                    if userAction == 'bomb'  or 'Bomb' or 'Throw a bomb' or 'throw a bomb':
                    ...
                    if userAction == 'bomb' or 'Bomb' or 'Throw a bomb' or 'throw a bomb':
                        ...
                        if userAction == 'pass' or 'Pass':
                            ...
                            if userAction == 'no' or 'No':
                                ...
                                if userAction == 'throw a bullet' or 'bullet' or 'Throw a bullet' or 'Bullet':
                                    ...
                                    if userAction == 'pass'  or 'Pass':
                                        ...
                                        if userAction == 'let it fly' or 'Let if fly':
                                            print('Sadly your dumb choice gave the ball to the other team via interception. GARBAGE!!!')
                                            defense = True
                                        if userAction == 'throw back corner' or 'Throw back corner:
                                    ...
                                    if userAction =='run' or 'Run':
                                        ...
                                        if userAction == 'yes' or 'Yes':
                                            ...
                                            if userAction == 'throw a bomb' or 'bomb' or 'Throw a bomb' or 'Bomb':
                                                print ('Congrats you are the worst quarterback in the world. Interception for you.')
                                                defense = True
                                            if userAction == 'finesse it' or 'Finesse it':
                                ...
                                if userAction == 'throw a bomb' or 'Throw a bomb':                                    
                                    print('Good call. The running back snags the football and streaks into the endzone. TOUCHDOWN!!! You win $10')
                                if userAction == 'wait for something else' or 'Wait for something else':
            ...
            if defense == True:
                ...
                if userAction == 'conservative defense' or 'Conservative' or 'Conservative defense' or 'conservative':
